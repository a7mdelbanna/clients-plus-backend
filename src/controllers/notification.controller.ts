...
export class NotificationController {
  ...
  async sendNotification(req: Request, res: Response): Promise<void> {
    try {
      const validatedData = validateData(SendNotificationSchema, req.body);
  ...
  async scheduleNotification(req: Request, res: Response): Promise<void> {
    try {
      const validatedData = validateData(ScheduleNotificationSchema, req.body);
      const user = (req as any).user;
  ...
  async sendBulkNotifications(req: Request, res: Response): Promise<void> {
    try {
      const validatedData = validateData(BulkNotificationSchema, req.body);
      const user = (req as any).user;
